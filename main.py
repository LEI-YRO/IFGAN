...
if __name__ == '__main__':
    ...
    parser.add_argument('--style_dim', type=int, default=1,
    ...
    parser.add_argument('--total_iters', type=int, default=100800,
    ...
    parser.add_argument('--val_batch_size', type=int, default=8,
                        help='Batch size for validation')#672 384
    ...
    parser.add_argument('--eval_every', type=int, default=100000000)
